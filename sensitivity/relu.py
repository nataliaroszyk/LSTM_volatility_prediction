...
model_save_path = 'lstm_garch_vix_relu.h5'
...
lstm_garch_vix_relu_results = pd.DataFrame(results)
lstm_garch_vix_relu_results.to_excel('results/results_lstm_garch_vix_relu.xlsx')
