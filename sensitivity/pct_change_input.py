...
# Load the datasets
# sp_lstm data
sp_lstm = pd.read_excel('data/sp500_lstm_pct_change.xlsx')
# sp_garch
...
#df.to_excel('data/sp500_lstm_garch_vix_pct_change.xlsx')
...
model_save_path = 'lstm_garch_vix_pct_change.h5'
...
lstm_garch_vix_pct_change_results = pd.DataFrame(results)
lstm_garch_vix_pct_change_results.to_excel('results/results_lstm_garch_vix_pct_change.xlsx')
