...
model_save_path = 'lstm_garch_vix_mae_loss.h5'
...
lstm_garch_vix_mae_loss_results = pd.DataFrame(results)
lstm_garch_vix_mae_loss_results.to_excel('results/results_lstm_garch_vix_mae_loss.xlsx')
