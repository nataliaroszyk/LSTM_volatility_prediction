...
model_save_path = 'lstm_garch_vix_layer_3.h5'
...
lstm_garch_vix_layers_3_results = pd.DataFrame(results)
lstm_garch_vix_layers_3_results.to_excel('results/results_lstm_garch_vix_3_layer.xlsx')
