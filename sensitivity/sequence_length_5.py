...
model_save_path = 'lstm_garch_vix_seq_length_5.h5'
...
lstm_garch_vix_seq_length_5_results = pd.DataFrame(results)
lstm_garch_vix_seq_length_5_results.to_excel('results/results_lstm_garch_vix_lookback_5.xlsx')
