...
model_save_path = 'lstm_garch_vix_seq_length_66.h5'
...
lstm_garch_vix_seq_length_66_results = pd.DataFrame(results)
lstm_garch_vix_seq_length_66_results.to_excel('results/results_lstm_garch_vix_lookback_66.xlsx')
